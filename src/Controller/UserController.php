...
class UserController extends AbstractController
{
     ...
     * 
     * @return The `listAction` function returns a rendered template 'user/list.html.twig' with a
     ...
     * @param ManagerRegistry
     * 
     * @return The `createAction` function returns a response that renders the `user/create.html.twig`
     ...
     * @param ManagerRegistry
     * 
     * @return The function `editAction` is returning a rendered template for the `user/edit.html.twig`
